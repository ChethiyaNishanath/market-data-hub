...
import (
	...
	ms "github.com/ChethiyaNishanath/market-data-hub/internal/market-state"
...
func MapOrderBookToSnapshot(symbol string, ob *ms.OrderBook) *pb.GetSnapshotReply {
